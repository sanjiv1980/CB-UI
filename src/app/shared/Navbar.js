    ...
    return (
      <nav className="navbar p-0 fixed-top d-flex flex-row">
        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          <span className='nav_logo'>CB UI</span>
          ...
          <ul className="navbar-nav navbar-nav-right">
            ...
            <Dropdown alignRight as="li" className="nav-item border-left" >
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list notification_drop">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      ...
                      <p className="tx-inverse mb-0"> 1 <Trans>Minutes ago</Trans> </p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      ...
                      <p className="tx-inverse mb-0"> 15 <Trans>Minutes ago</Trans> </p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      ...
                      <p className="tx-inverse mb-0"> 18 <Trans>Minutes ago</Trans> </p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
            ...
            <Dropdown alignRight as="li" className="nav-item border-left">
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list notification_drop">
                <h6 className="p-3 mb-0"><Trans>Notifications</Trans></h6>
                <Dropdown.Divider />
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  <div className="preview-thumbnail">
                    <div className="preview-icon rounded-circle prv-icon">
                      <i className="mdi mdi-calendar white_color"></i>
                    </div>
                  </div>
                  <div className="preview-item-content">
                    <p className="preview-subject mb-1"><Trans>Event today</Trans></p>
                    <p className="tx-inverse ellipsis mb-0">
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  <div className="preview-thumbnail">
                    <div className="preview-icon rounded-circle prv-icon">
                      <i className="mdi mdi-settings white_color"></i>
                    </div>
                  </div>
                  <div className="preview-item-content">
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  <div className="preview-thumbnail">
                    <div className="preview-icon rounded-circle prv-icon">
                      <i className="mdi mdi-link-variant white_color"></i>
                    </div>
                  </div>
                  <div className="preview-item-content">
                ...
                <Dropdown.Divider />
                <p className="p-3 mb-0 text-center all_notofication"><Trans>See all notifications</Trans></p>
              </Dropdown.Menu>
            </Dropdown>
            <Dropdown alignRight as="li" className="nav-item">
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
                ...
                <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}  className="preview-item">
                  <div className="preview-thumbnail">
                    <div className="preview-icon bg_blue rounded-circle">
                      <i className="mdi mdi-logout white_color"></i>
                    </div>
                  </div>
                  <div className="preview-item-content">
